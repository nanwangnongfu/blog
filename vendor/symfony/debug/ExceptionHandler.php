...
class ExceptionHandler
{
    ...
    const GHOST_HEART = 'M125.914 8.305c3.036-8.71 14.933 0 0 11.2-14.932-11.2-3.036-19.91 0-11.2z';
    const GHOST_PLUS = 'M111.368 8.97h7.324V1.645h7.512v7.323h7.324v7.513h-7.324v7.323h-7.512v-7.323h-7.324z';
    ...
    public function __construct($debug = true, string $charset = null, $fileLinkFormat = null)
    {
        $this->debug = $debug;
